...
public class HomePage extends BasePage {
        ...
        private By maleRadioButton=By.xpath("//android.widget.RadioButton[@resource-id='com.androidsample.generalstore:id/radioMale']");
        ...
        private By addCartButton =By.xpath("//android.widget.TextView[@text='ADD TO CART']");
        ...
        private void addProductsToCart() {
                driver.findElements(addCartButton).get(0).click();
                driver.findElements(addCartButton).get(0).click();
